...
def courses(term = "Spring 2020"):
    ...
    return render_template("courses.html",login=True, courseData = courseData, term=term)
...
def enrollment():
    ...
    return render_template("enrollment.html",login=True, data={"id":id, "title":title, "term":term})
